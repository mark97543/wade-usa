...
const Row2Planner = () =>{
    const {setTripNames,tripNames, setSelectedValue, selectedValue}=useContext(StatesContext)
    return(
        <div id='row2travel'>
            <div id='row2box1'>
                <label htmlFor="destination" id='destinationLabel'>Destination</label>
                <input type="text" className="form-control" value={selectedValue} placeholder="Default input" id="destination" onBlur={DestinationNameChange({setTripNames:setTripNames, tripNames:tripNames, setSelectedValue:setSelectedValue})}/>
            </div>
            <div id='row2box2'>
